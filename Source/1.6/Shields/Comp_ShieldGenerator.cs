...
namespace Jaxxa.EnhancedDevelopment.Shields.Shields
{
    ...
    public class Comp_ShieldGenerator : ThingComp
    {
        ...
        public void DrawSubField(Vector3 position, float shieldShieldRadius)
        {
            ...
            Vector3 s = new Vector3(shieldShieldRadius * 2f * 1.16015625f, 1f, shieldShieldRadius * 2f * 1.16015625f);

            Matrix4x4 matrix4x = default(Matrix4x4);
            matrix4x.SetTRS(position, Quaternion.identity, s);
            UnityEngine.Graphics.DrawMesh(MeshPool.plane10, matrix4x, CompProjectileInterceptor.ForceFieldMat, 0, null, 0, CompProjectileInterceptor.MatPropertyBlock);
